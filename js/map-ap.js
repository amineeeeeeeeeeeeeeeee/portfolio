...
// bepaal de rechthoek rondom het gebouw van AP - nu met blauwe kleur
let bounds = [[51.23041, 4.4155], [51.22991, 4.41675]];

// kleur de rechthoek in met blauwe kleur
L.rectangle(bounds, { color: "#0d6efd", weight: 2, opacity: 0.8 }).addTo(map);

// plaats een marker met als tekst "AP-Hogeschool" en eronder "Ellermanstraat 33" - blauwe marker
